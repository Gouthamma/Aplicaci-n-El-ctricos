        ...
        private void BtGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (CapaEntidad.Boton.Btn)
            {
                try
                {
                    ...
                    {
                        rpta = NConstructora.Editar(Convert.ToInt32(this.ID.Text), Convert.ToString(this.LbNombre.Text),
            ...
            else
            {
                try
                {
                    ...
                    {
                        rpta = NConstructora.Insertar(this.LbNombre.Text, this.LbCoorProy.Text,
